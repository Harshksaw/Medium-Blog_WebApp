...
import worker from "/workspaces/Medium-Blog_WebApp/backend/.wrangler/tmp/bundle-BbOG2P/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/workspaces/Medium-Blog_WebApp/backend/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/workspaces/Medium-Blog_WebApp/backend/.wrangler/tmp/bundle-BbOG2P/middleware-insertion-facade.js";
