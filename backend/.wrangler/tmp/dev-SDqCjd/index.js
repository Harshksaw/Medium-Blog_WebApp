...
// .wrangler/tmp/bundle-CJrUOT/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/harshsaw/Documents/GitHub/Medium-Blog_WebApp/backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
...
// .wrangler/tmp/bundle-CJrUOT/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-CJrUOT/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
blogRouter.use("/*", async (c, next) => {
  ...
  const user = verify2(token, c.env.JWT_SECRET);
  if (user) {
